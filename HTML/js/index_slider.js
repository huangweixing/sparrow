...
(function(A, w) {
    ...
    c.fn = c.prototype = {
        ...
        pushStack: function(a, b, d) {
            ...
            if (b === "find")
                f.selector = this.selector + (this.selector
                    ? " "
                    : "") + d;
            else if (b)
                ...
                for (j in e) {
                    ...
                    if (a !== o)
                        if (f && o && (c.isPlainObject(o) || c.isArray(o))) {
                            i = i && (c.isPlainObject(i) || c.isArray(i))
                                ? i
                                : c.isArray(o)
                                    ? []
                                    : {};
    ...
    c.extend({
        ...
        attr: function(a, b, d, f) {
            ...
            if (a.nodeType === 1) {
                ...
                a = !c.support.hrefNormalized && f && j
                    ? a.getAttribute(b, 2)
                    : a.getAttribute(b);
                return a === null
                    ? w
    ...
    c.event = {
        ...
        fix: function(a) {
            ...
            if (!a.which && (a.charCode || a.charCode === 0
                ? a.charCode
                : a.keyCode))
    ...
    c.each({
        ...
        c.event.special[a] = {
            ...
            teardown: function(d) {
                c.event.remove(this, b, d && d.selector
                    ? Ea
                    : Da)
            }
        }
    ...
    (function() {
        ...
        var k = function(g, h, l, m) {
            ...
            if (p.length > 1 && r.exec(g))
                if (p.length === 2 && n.relative[p[0]])
                    ...
                    for (t = n.relative[p[0]]
                        ? [h]
                        : k(p.shift(), h); p.length;) {
                        g = p.shift();
                        if (n.relative[g])
                            g += p.shift();
                        t = ga(g, t)
                    ...
                    "+": function(g, h) {
                        ...
                        for (var q = g.length, p; m < q; m++)
                            if (p = g[m]) {
                                ...
                                ;
                                g[m] = l || p && p.nodeName.toLowerCase() === h
                                    ? p || false
                                    : p === h
                            }
                        l && k.filter(h, g, true)
        ...
        if (s.documentElement.compareDocumentPosition)
            B = function(g, h) {
                ...
                g = g.compareDocumentPosition(h) & 4
                    ? -1
                    : g === h
                        ? 0
                        : 1;
    ...
    c.fn.extend({
        ...
        add: function(a, b) {
            ...
            return this.pushStack(qa(a[0]) || qa(b[0])
                ? b
                : c.unique(b))
        },
        andSelf: function() {
    ...
    c.fn.extend({
        ...
        replaceWith: function(a) {
            if (this[0] && this[0].parentNode) {
                ...
                return this.pushStack(c(c.isFunction(a)
                    ? a()
                    : a), "replaceWith", a)
            },
        detach: function(a) {
            ...
            if (this[0]) {
                ...
                if (j = k.childNodes.length === 1
                    ...
                    for (var n = 0, r = this.length; n < r; n++)
                        d.call(b
                            ? f(this[n], j)
                            : this[n], n > 0 || e.cacheable || this.length > 1
                            ? k.cloneNode(true)
                            : k)
                    }
                ...
                for (j = 0; e[j]; j++)
                    if (f && c.nodeName(e[j], "script") && (!e[j].type || e[j].type.toLowerCase() === "text/javascript"))
                        ...
                        e[j].nodeType === 1 && e.splice.apply(e, [
                            j + 1,
                            0
                        ].concat(c.makeArray(e[j].getElementsByTagName("script"))));
                        d.appendChild(e[j])
                    }
                return e
        },
    ...
    c.extend({
        ...
        handleError: function(a, b, d, f) {
            ...
            if (a.global)
                (a.context
                    ? c(a.context)
                    : c.event).trigger("ajaxError", [b, a, f])
            },
        active: 0,
            ...
            function d(i, o) {
                if (c.isArray(o))
                    c.each(o, function(k, n) {
                        b || /\[\]$/.test(i)
                            ? f(i, n)
                            : d(i + "[" + (typeof n === "object" || c.isArray(n)
                                ? k
                                : "") + "]", n)
                    });
                else
    ...
    c.fx.prototype = {
        ...
        step: function(a) {
            ...
            if (d) {
                ...
                a = this.options.easing || (c.easing.swing
                    ? "swing"
                    : "linear");
